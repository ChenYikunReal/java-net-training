...
public class MyServer {
        ...
        public void completed(final AsynchronousSocketChannel sc, Object attachment) {
            ...
            sc.read(buff , null, new CompletionHandler<Integer,Object>() {
                ...
                public void completed(Integer result, Object attachment) {
                    ...
                    for(AsynchronousSocketChannel c : MyServer.channelList) {
                        try {
                ...
                public void failed(Throwable ex, Object attachment) {
                    ...
                    MyServer.channelList.remove(sc);
                }
            });
        }
    ...
    public void startListen() throws Exception {
        ...
        AsynchronousServerSocketChannel serverChannel = AsynchronousServerSocketChannel.open(channelGroup).bind(new InetSocketAddress(PORT)); // 指定监听本机的PORT端口
